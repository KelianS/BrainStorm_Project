...
public class DeviceScanActivity extends ListActivity {
    ...
    @Override
    /**
     * Executed when this activity has focus
     */
    ...
    @Override
    /**
     * return from second lunched activity
     */
    ...
    @Override
    // clic on a device -> start DeviceControlactivity
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        private void addDevice(BluetoothDevice device) {
            ...
            if((!mLeDevices.contains (device)) && (deviceName != null) && (deviceName.length() > 0)) { //delete unknown device
